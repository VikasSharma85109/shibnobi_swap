...
const Removeliquidity = ({
  ...
  /** 
   Author:- vikas
  Description:- this methods used set coin Address , symbol..etc
   **/
  ...
  /**
     Author:- vikas
    Description:- this function used add liquidity coin address and percentage
     **/
  ...
  /**
    Author:- vikas
   Description:- this function check approveRouter function
    **/
  ...
  /** 
   Author:- vikas
   Description:- this method check handleSymbol from set Data symbol address etc
   **/
  ...
  /**
   Author:- vikas
   Description:- this method check handleSymbol To input set Data symbol address etc
   **/
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {dropDownValueChange ? dropDownValueChange : "Select a currency"}{" "}
                      {"  "}
                      {usingFor != "0" ? null : (
                        <svg
                          width="12"
              ...
              >
                ...
                >
                  <div style={{ marginLeft: "5px" }}>
                    ...
                    >
                      {usingFor != "0" ? null : <p>Balance {tobal}</p>}
                    </div>
                    <input
                      style={{
                        backgroundColor: "#212429",
