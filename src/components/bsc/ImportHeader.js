...
import { Figure, Form, Modal } from "react-bootstrap";
...
const ImportHeader = ({ back, setAddshow1, provider }) => {
  ...
  /** Author:- vikas
  Description:- this function used open and closed popUp
 **/
  ...
  /**
   Author:-vikas
   Description :- this methods used handle model
  **/
  ...
  /**
     Author:-vikas
     Description :- model open and closed
    **/
